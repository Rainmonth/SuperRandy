...
public abstract class PLAAbsListView extends PLAAdapterView<ListAdapter> implements
    ...
    /**
     * The last scroll state reported to clients through {@link com.rainmonth.library.pla.PLAAbsListView.OnScrollListener}.
     */
    ...
    public interface OnScrollListener {
         ...
         */
        void onScrollStateChanged(PLAAbsListView view, int scrollState);
    ...
    public PLAAbsListView(Context context) {
        ...
        try {
            ...
            final Method initializeScrollbars = View.class.getDeclaredMethod("initializeScrollbars",
                    TypedArray.class);
