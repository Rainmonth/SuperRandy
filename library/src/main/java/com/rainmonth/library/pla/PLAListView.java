package com.rainmonth.library.pla;
...
public class PLAListView extends PLAAbsListView {
     ...
     * the choice mode has been set to CHOICE_MODE_SINGLE or CHOICE_MODE_MULTIPLE.
     *
     ...
     * valid if the choice mode has been set to {@link android.widget.ListView#CHOICE_MODE_SINGLE}
     * or {@link android.widget.ListView#CHOICE_MODE_MULTIPLE}.
     *
     ...
     * mode has been set to {@link android.widget.ListView#CHOICE_MODE_SINGLE}.
     *
     ...
     * the choice mode has not been set to {@link android.widget.ListView#CHOICE_MODE_NONE}.
     *
     ...
     * choice mode has not been set to {@link android.widget.ListView#CHOICE_MODE_NONE}.
     *
    ...
    /**
     * Returns the set of checked items ids. The result is only valid if the
     * choice mode has not been set to {@link android.widget.ListView#CHOICE_MODE_NONE} and the adapter
