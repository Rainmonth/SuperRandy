package com.rainmonth.music.core.utils;
...
import com.rainmonth.music.core.render.view.video.base.Layer3ScreenAdapterLayout;
...
public class OrientationUtils {
    ...
    private Layer3ScreenAdapterLayout mVideoPlayer;
     ...
     */
    public OrientationUtils(Activity activity, Layer3ScreenAdapterLayout gsyVideoPlayer) {
                ...
                if (((rotation >= 0) && (rotation <= 30)) || (rotation >= 330)) {
                    if (mClick) {
                        ...
                        if (mIsLand > LAND_TYPE_NULL) {
                            ...
                            if (mVideoPlayer.getFullscreeBtn() != null) {
                                if (mVideoPlayer.isCurrentFullscreen()) {
                                    mVideoPlayer.getFullscreeBtn().setImageResource(mVideoPlayer.getShrinkImageRes());
                                } else {
                                    mVideoPlayer.getFullscreeBtn().setImageResource(mVideoPlayer.getEnlargeImageRes());
                                }
                            }
                            mIsLand = LAND_TYPE_NULL;
                            mClick = false;
    ...
    public int backToProtVideo() {
        if (mIsLand > LAND_TYPE_NULL) {
            mClick = true;
            mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            if (mVideoPlayer != null && mVideoPlayer.getFullscreeBtn() != null)
                mVideoPlayer.getFullscreeBtn().setImageResource(mVideoPlayer.getEnlargeImageRes());
            mIsLand = LAND_TYPE_NULL;
            mClickPort = false;
            return 500;
