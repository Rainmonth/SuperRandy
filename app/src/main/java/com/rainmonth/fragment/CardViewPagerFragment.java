...
import com.rainmonth.widgets.ptr.extras.viewpager.PullToRefreshViewPager;
...
public class CardViewPagerFragment extends BaseLazyFragment implements PullToRefreshBase.OnRefreshListener<ViewPager> {
    ...
    private void onAppPagerChange(int position) {
        ...
        CardInfo post = this.mCardList.get(position);
        //得到当前的背景颜色
    ...
    private void updateAppAdapter(List<CardInfo> cardList) {
    ...
    private void addCardIconsToDock(final List<CardInfo> cardList) {
    ...
    //重置钢琴控件数据源
    private void resetRhythmLayout(List<CardInfo> cardList) {
        if (getActivity() == null)
            return;
        if (cardList == null)
    ...
    private CardInfo addData(int i) {
        ...
        switch (i) {
            case 0:
                ...
                card.setCoverImageUrl("card_cover1");
            ...
            case 1:
                ...
                card.setCoverImageUrl("card_cover2");
            ...
            case 2:
                ...
                card.setBackgroundColor("#00aac6");
                card.setCoverImageUrl("card_cover3");
            ...
            case 3:
                ...
                card.setCoverImageUrl("card_cover4");
            ...
            case 4:
                ...
                card.setCoverImageUrl("card_cover5");
            ...
            case 5:
                ...
                card.setCoverImageUrl("card_cover6");
            ...
            case 6:
                ...
                card.setCoverImageUrl("card_cover7");
            ...
            case 7:
                ...
                card.setAuthorName("小美");
                card.setBackgroundColor("#e76153");
                card.setCoverImageUrl("card_cover8");
