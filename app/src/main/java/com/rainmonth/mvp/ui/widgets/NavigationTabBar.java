...
package com.rainmonth.mvp.ui.widgets;
...
public class NavigationTabBar extends View implements ViewPager.OnPageChangeListener {
     ...
     * 是否显示标题
     *
     * @return true if 显示标题，otherwise false；
     */
    ...
    public void setViewPager(final ViewPager viewPager) {
        ...
        if (viewPager.getAdapter() == null)
            throw new IllegalStateException("ViewPager does not provide com.rainmonth.library.adapter instance.");
    ...
    /**
     * 通过反射机制来重置ViewPager中的mScroller属性，让其mScroller的持续时间同动画时间相等
     */
