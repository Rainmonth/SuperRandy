 ...
 * 用户的图片
 */
public class UserPhotosFragment extends BaseLazyFragment implements UserCenterContract.View {
...
//
        ...
        rvUserPhotos.setAdapter(photosAdapter);
        LinearLayoutManager manager = new LinearLayoutManager(mContext);
        rvUserPhotos.setLayoutManager(manager);
        doRefresh();
    }
    ...
    private void doRefresh() {
        ...
        page = 1;
        userCenterPresenter.getUserPhotos(username, page, perPage, orderBy);
    }
