...
import com.rainmonth.player.gsy.utils.OrientationOption;
import com.rainmonth.player.gsy.utils.OrientationUtils;
import com.rainmonth.player.gsy.view.SmallVideoTouch;

import java.lang.reflect.Constructor;

import static com.rainmonth.player.gsy.utils.CommonUtil.getActionBarHeight;
import static com.rainmonth.player.gsy.utils.CommonUtil.getStatusBarHeight;
import static com.rainmonth.player.gsy.utils.CommonUtil.hideNavKey;
import static com.rainmonth.player.gsy.utils.CommonUtil.hideSupportActionBar;
import static com.rainmonth.player.gsy.utils.CommonUtil.showNavKey;
import static com.rainmonth.player.gsy.utils.CommonUtil.showSupportActionBar;
...
public abstract class GSYBaseVideoPlayer extends GSYVideoControlView {
    ...
    private void saveLocationStatus(Context context, boolean statusBar, boolean actionBar) {
        ...
        if (context instanceof Activity) {
            ...
            Debugger.printfLog("*************isTranslucent*************** " + isTranslucent);
    ...
    protected void resolveFullVideoShow(Context context, final GSYBaseVideoPlayer gsyVideoPlayer, final FrameLayout frameLayout) {
        ...
        if (mVideoAllCallBack != null) {
            Debugger.printfError("onEnterFullscreen");
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (mVideoAllCallBack != null) {
            Debugger.printfError("onQuitFullscreen");
    ...
    protected boolean isVerticalVideo() {
        ...
        Debugger.printfLog("GSYVideoBase isVerticalVideo  videoHeight " + videoHeight + " videoWidth " + videoWidth);
        Debugger.printfLog("GSYVideoBase isVerticalVideo  mRotate " + mRotate);
    ...
    protected void checkAutoFullSizeWhenFull() {
        if (mIfCurrentIsFullscreen) {
            ...
            Debugger.printfLog("GSYVideoBase onPrepared isVerticalFullByVideoSize " + isV);
            if (isV) {
                if (mOrientationUtils != null) {
    ...
    public void hideSmallVideo() {
        ...
        mSaveChangeViewTIme = System.currentTimeMillis();
        if (mVideoAllCallBack != null) {
            Debugger.printfLog("onQuitSmallWidget");
    ...
    protected void autoAdaptation() {
        ...
        if (isVerticalVideo()) {
            ...
            if (location[1] == 0) {
                ...
                Debugger.printfLog("竖屏，系统未将布局下移");
            } else {
                Debugger.printfLog("竖屏，系统将布局下移；y:" + location[1]);
            }
        }
    }
}
