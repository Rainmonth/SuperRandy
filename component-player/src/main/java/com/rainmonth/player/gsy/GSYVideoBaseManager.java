package com.rainmonth.player.gsy;
...
import com.rainmonth.player.gsy.base.cache.CacheFactory;
import com.rainmonth.player.gsy.base.player.ICacheManager;
import com.rainmonth.player.gsy.listener.GSYMediaPlayerListener;
import com.rainmonth.player.gsy.model.GSYModel;
import com.rainmonth.player.gsy.model.VideoOptionModel;
import com.rainmonth.player.gsy.base.player.BasePlayerManager;
import com.rainmonth.player.gsy.player.IPlayerInitSuccessListener;
import com.rainmonth.player.gsy.base.player.IPlayerManager;
import com.rainmonth.player.gsy.base.player.PlayerFactory;
import com.rainmonth.player.gsy.utils.Debugger;
import com.rainmonth.player.gsy.video.base.GSYVideoViewBridge;
...
public abstract class GSYVideoBaseManager implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnCompletionListener,
    ...
    protected void startTimeOutBuffer() {
        // 启动定时
        Debugger.printfError("startTimeOutBuffer");
    ...
    protected void cancelTimeOutBuffer() {
        Debugger.printfError("cancelTimeOutBuffer");
        // 取消定时
        if (needTimeOutOther)
    ...
    private Runnable mTimeOutRunnable = new Runnable() {
        ...
        public void run() {
            if (listener != null) {
                Debugger.printfError("time out for error listener");
