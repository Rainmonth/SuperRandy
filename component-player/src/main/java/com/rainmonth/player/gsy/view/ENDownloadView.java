package com.rainmonth.player.gsy.view;
...
public class ENDownloadView extends View {
    ...
    public ENDownloadView(Context context, AttributeSet attrs) {
        ...
        int lineColor = ta.getColor(R.styleable.PlayerDownloadBtn_download_line_color, DEFAULT_LINE_COLOR);
        int bgLineColor = ta.getColor(R.styleable.PlayerDownloadBtn_download_bg_line_color, DEFAULT_BG_LINE_COLOR);
        int textColor = ta.getColor(R.styleable.PlayerDownloadBtn_download_text_color, DEFAULT_TEXT_COLOR);
        int lineWidth = ta.getInteger(R.styleable.PlayerDownloadBtn_download_line_width, DEFAULT_LINE_WIDTH);
        int bgLineWidth = ta.getInteger(R.styleable.PlayerDownloadBtn_download_bg_line_width, DEFAULT_BG_LINE_WIDTH);
        int textSize = ta.getInteger(R.styleable.PlayerDownloadBtn_download_text_size, DEFAULT_TEXT_SIZE);
        ta.recycle();
