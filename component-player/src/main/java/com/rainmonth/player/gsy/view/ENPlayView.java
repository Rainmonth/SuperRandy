...
public class ENPlayView extends View {
    ...
    public ENPlayView(Context context, AttributeSet attrs) {
        ...
        int lineColor = ta.getColor(R.styleable.PlayerPlayBtn_play_line_color, DEFAULT_LINE_COLOR);
        int bgLineColor = ta.getColor(R.styleable.PlayerPlayBtn_play_bg_line_color, DEFAULT_BG_LINE_COLOR);
        int lineWidth = ta.getInteger(R.styleable.PlayerPlayBtn_play_line_width, dp2px(DEFAULT_LINE_WIDTH));
        int bgLineWidth = ta.getInteger(R.styleable.PlayerPlayBtn_play_bg_line_width, dp2px(DEFAULT_BG_LINE_WIDTH));
        ta.recycle();
