package com.rainmonth.player.gsy.utils;
...
import com.rainmonth.player.gsy.builder.GSYVideoOptionBuilder;
...
import com.rainmonth.player.gsy.listener.VideoAllCallBack;
import com.rainmonth.player.gsy.render.view.GSYVideoGLView;
import com.rainmonth.player.gsy.video.StandardGSYVideoPlayer;
...
public class GSYVideoHelper {
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (mVideoOptionBuilder.getVideoAllCallBack() != null) {
                    Debugger.printfLog("onQuitFullscreen");
    ...
    private void resolveChangeFirstLogic(int time) {
        ...
        mGsyVideoPlayer.restartTimerTask();
        if (mVideoOptionBuilder.getVideoAllCallBack() != null) {
            Debugger.printfLog("onEnterFullscreen");
