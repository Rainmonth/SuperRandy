package com.rainmonth.player.gsy.video;
...
import com.rainmonth.player.gsy.listener.GSYVideoShotListener;
import com.rainmonth.player.gsy.listener.GSYVideoShotSaveListener;
import com.rainmonth.player.gsy.utils.Debugger;
import com.rainmonth.player.gsy.utils.NetworkUtils;
import com.rainmonth.player.gsy.video.base.GSYBaseVideoPlayer;
import com.rainmonth.player.gsy.video.base.GSYVideoPlayer;
import com.rainmonth.player.gsy.view.ENDownloadView;
import com.rainmonth.player.gsy.view.ENPlayView;
...
public class StandardGSYVideoPlayer extends GSYVideoPlayer {
    ...
    protected void showWifiDialog() {
        ...
        builder.setMessage(getResources().getString(R.string.player_tips_not_wifi));
        builder.setPositiveButton(getResources().getString(R.string.player_tips_not_wifi_confirm), new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(getResources().getString(R.string.player_tips_not_wifi_cancel), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
    ...
    protected void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        if (mProgressDialog == null) {
            ...
            mProgressDialog = new Dialog(getActivityContext(), R.style.player_style_dialog_progress);
    ...
    protected void showVolumeDialog(float deltaY, int volumePercent) {
        if (mVolumeDialog == null) {
            ...
            mVolumeDialog = new Dialog(getActivityContext(), R.style.player_style_dialog_progress);
    ...
    protected void showBrightnessDialog(float percent) {
        if (mBrightnessDialog == null) {
            ...
            mBrightnessDialog = new Dialog(getActivityContext(), R.style.player_style_dialog_progress);
    ...
    protected void changeUiToNormal() {
        Debugger.printfLog("changeUiToNormal");
    ...
    protected void changeUiToPreparingShow() {
        Debugger.printfLog("changeUiToPreparingShow");
    ...
    protected void changeUiToPlayingShow() {
        Debugger.printfLog("changeUiToPlayingShow");
    ...
    protected void changeUiToPauseShow() {
        Debugger.printfLog("changeUiToPauseShow");
    ...
    protected void changeUiToPlayingBufferingShow() {
        Debugger.printfLog("changeUiToPlayingBufferingShow");
    ...
    protected void changeUiToCompleteShow() {
        Debugger.printfLog("changeUiToCompleteShow");
    ...
    protected void changeUiToError() {
        Debugger.printfLog("changeUiToError");
    ...
    protected void changeUiToPrepareingClear() {
        Debugger.printfLog("changeUiToPrepareingClear");
    ...
    protected void changeUiToPlayingClear() {
        Debugger.printfLog("changeUiToPlayingClear");
        changeUiToClear();
        setViewShowState(mBottomProgressBar, VISIBLE);
    }

    protected void changeUiToPauseClear() {
        Debugger.printfLog("changeUiToPauseClear");
        changeUiToClear();
        setViewShowState(mBottomProgressBar, VISIBLE);
        updatePauseCover();
    }
    ...
    protected void changeUiToPlayingBufferingClear() {
        Debugger.printfLog("changeUiToPlayingBufferingClear");
    ...
    protected void changeUiToClear() {
        Debugger.printfLog("changeUiToClear");
    ...
    protected void changeUiToCompleteClear() {
        Debugger.printfLog("changeUiToCompleteClear");
