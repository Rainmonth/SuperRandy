...
import com.rainmonth.player.gsy.model.GSYVideoModel;
...
public class GSYSampleADVideoPlayer extends ListGSYVideoPlayer {
    ...
    protected void changeAdUIState() {
        ...
        if (mBottomContainer != null) {
            int color = (isFirstPrepared && isAdModel) ? Color.TRANSPARENT : getContext().getResources().getColor(R.color.player_bottom_container_bg);
