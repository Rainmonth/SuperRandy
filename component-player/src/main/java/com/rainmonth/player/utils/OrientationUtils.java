...
public class OrientationUtils {
    ...
    public OrientationUtils(Activity activity, BaseVideoPlayer gsyVideoPlayer, OrientationOption orientationOption) {
    ...
    private void setRequestedOrientation(int requestedOrientation) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.O || Build.VERSION.SDK_INT == Build.VERSION_CODES.O_MR1) {
                Debugger.printfError("OrientationUtils", exception);
            } else {
