...
public class IjkExo2MediaPlayer extends AbstractMediaPlayer implements Player.EventListener, AnalyticsListener {
    public static int ON_POSITION_DISCONTINUITY = 2702;

    private static final String TAG = IjkExo2MediaPlayer.class.getSimpleName();
    ...
    public void onPositionDiscontinuity(EventTime eventTime, int reason) {
        notifyOnInfo(ON_POSITION_DISCONTINUITY, reason);
    }
