...
public final class ManifestParser {
    ...
    private static ConfigModule parseModule(String className) {
        ...
        try {
            ...
            throw new RuntimeException("Unable to instantiate ConfigModule " +
                    "implementation for " + clazz, e);
        } catch (IllegalAccessException e) {
            throw new RuntimeException("Unable to access ConfigModule " +
                    "implementation for " + clazz, e);
        }
        if (!(module instanceof ConfigModule)) {
            throw new RuntimeException("Expected instanceof ConfigModule, but " +
                    "found: " + module);
        }
